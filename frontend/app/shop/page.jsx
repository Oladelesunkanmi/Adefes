                                ...
                                <div className="absolute top-full right-0 mt-2 w-48 bg-white border border-gray-100 shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-20">
                                    {[
                                        ...
                                        <button
                                            ...
                                            className="w-full text-left px-6 py-4 hover:bg-gray-50 transition-colors border-b border-gray-50 last:border-0 uppercase"
                                        >
                                            {option.label}
                                        </button>
                                    ))}
                        ...
                        <div className="flex-1">
                            {loading ? (
                                ...
                                <div className="text-center py-32 bg-gray-50 rounded-lg">
                                    <p className="text-gray-400 font-playfair italic text-2xl mb-6">No pieces found.</p>
                                </div>
                            ) : (
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
