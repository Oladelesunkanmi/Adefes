    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-brand-dark-gray px-4 py-8 sm:py-12">
            <div className="max-w-md w-full bg-white p-6 sm:p-8 shadow-md border border-gray-100">
                <h2 className="text-2xl sm:text-3xl font-playfair font-bold text-center mb-2 sm:mb-3 text-black">Create Account</h2>
                <p className="text-center text-gray-500 text-sm mb-6 sm:mb-8">Join Adefes Fashion House</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
                    ...
                    <div>
                        <label className="block text-sm font-bold mb-2 text-gray-800">Confirm Password</label>
                        <div className="relative">
                            <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-600" />
                            <input
                                type="password"
                ...
                <p className="text-center mt-5 sm:mt-6 text-xs sm:text-sm text-gray-600">
                    Already have an account? <Link href="/login" className="font-bold underline hover:text-black">Sign In</Link>
                </p>
            </div>
        </div>
    );
