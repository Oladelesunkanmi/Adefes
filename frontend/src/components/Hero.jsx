    ...
    return (
        <section className="relative h-[85vh] w-full bg-brand-gray overflow-hidden" aria-label="Hero Banner">
            ...
            <div className="relative h-full flex flex-col justify-center items-center text-center px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
                <span className="text-white uppercase tracking-[0.3em] mb-3 sm:mb-5 text-xs sm:text-sm font-bold animate-fade-in-up drop-shadow-md">Agbada Collection 2026</span>
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-playfair font-bold !text-brand-gold mb-6 sm:mb-8 tracking-wide animate-fade-in-up delay-100 leading-tight px-4 drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]">
