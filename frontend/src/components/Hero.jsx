    ...
    return (
        <section className="relative h-[85vh] w-full bg-brand-gray overflow-hidden" aria-label="Hero Banner">
            ...
            <div className="relative h-full flex flex-col justify-center items-center text-center px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
                ...
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-playfair font-bold text-white mb-6 sm:mb-8 tracking-wide animate-fade-in-up delay-100 leading-tight px-4 drop-shadow-lg">
                ...
                <Link
                    to="/shop"
                    className="group bg-brand-gold text-white px-8 sm:px-10 py-3 sm:py-4 uppercase tracking-[0.2em] text-xs sm:text-sm font-bold flex items-center gap-3 hover:bg-brand-emerald hover:-translate-y-1 hover:shadow-xl transition-all duration-300 animate-fade-in-up delay-300 rounded-sm"
